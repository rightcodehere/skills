#!/usr/bin/env python3
"""
rightcode-skill-updater: check.py
...
# ─────────────────────────────────────────────────────────────────────────────
MATTPOCOCK_SKILLS = [
    {"cat": "engineering",  "up": "diagnose",                      "local": "rightcode-diagnose",                      "files": ["SKILL.md", "scripts/hitl-loop.template.sh"]},
    {"cat": "engineering",  "up": "grill-with-docs",               "local": "rightcode-grill-with-docs",               "files": ["SKILL.md", "ADR-FORMAT.md", "CONTEXT-FORMAT.md"]},
    {"cat": "engineering",  "up": "improve-codebase-architecture",  "local": "rightcode-improve-codebase-architecture",  "files": ["SKILL.md", "DEEPENING.md", "INTERFACE-DESIGN.md", "LANGUAGE.md"]},
    {"cat": "engineering",  "up": "prototype",                     "local": "rightcode-prototype",                     "files": ["SKILL.md", "LOGIC.md", "UI.md"]},
    {"cat": "engineering",  "up": "setup-matt-pocock-skills",      "local": "rightcode-setup-skills",                  "files": ["SKILL.md", "domain.md", "issue-tracker-github.md", "issue-tracker-gitlab.md", "issue-tracker-local.md", "triage-labels.md"]},
    {"cat": "engineering",  "up": "tdd",                           "local": "rightcode-tdd",                           "files": ["SKILL.md", "deep-modules.md", "interface-design.md", "mocking.md", "refactoring.md", "tests.md"]},
    {"cat": "engineering",  "up": "to-issues",                     "local": "rightcode-to-issues",                     "files": ["SKILL.md"]},
    {"cat": "engineering",  "up": "to-prd",                        "local": "rightcode-to-prd",                        "files": ["SKILL.md"]},
    {"cat": "engineering",  "up": "triage",                        "local": "rightcode-triage",                        "files": ["SKILL.md", "AGENT-BRIEF.md", "OUT-OF-SCOPE.md"]},
    {"cat": "engineering",  "up": "zoom-out",                      "local": "rightcode-zoom-out",                      "files": ["SKILL.md"]},
    {"cat": "productivity", "up": "caveman",                       "local": "rightcode-caveman",                       "files": ["SKILL.md"]},
    {"cat": "productivity", "up": "grill-me",                      "local": "rightcode-grill-me",                      "files": ["SKILL.md"]},
    {"cat": "productivity", "up": "handoff",                       "local": "rightcode-handoff",                       "files": ["SKILL.md"]},
    {"cat": "productivity", "up": "write-a-skill",                 "local": "rightcode-write-a-skill",                 "files": ["SKILL.md"]},
    {"cat": "misc",         "up": "git-guardrails-claude-code",    "local": "rightcode-git-guardrails",                "files": ["SKILL.md", "scripts/block-dangerous-git.sh"]},
    {"cat": "misc",         "up": "migrate-to-shoehorn",           "local": "rightcode-migrate-to-shoehorn",           "files": ["SKILL.md"]},
    {"cat": "misc",         "up": "scaffold-exercises",            "local": "rightcode-scaffold-exercises",            "files": ["SKILL.md"]},
    {"cat": "misc",         "up": "setup-pre-commit",              "local": "rightcode-setup-pre-commit",              "files": ["SKILL.md"]},
]
...
LOCAL_ONLY_SKILLS = [
    ...
    "rightcode-codeprobe-error-handling",
    "rightcode-codeprobe-framework",
    "rightcode-codeprobe-patterns",
    "rightcode-codeprobe-performance",
    "rightcode-codeprobe-security",
...
def diff_code_review_skill(skills_root: Path) -> dict:
    print()
    print(cyan("Phase 2b: Diffing rightcode-code-review against awesome-skills/code-review-skill..."))
